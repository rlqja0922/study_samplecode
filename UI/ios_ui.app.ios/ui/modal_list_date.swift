        ...
        NavigationView {
            VStack(alignment: .center) {
                ZStack {
                    ...
                    HStack {
                        NavigationLink(destination: viewrender(motion: MotionManager()), tag: 5, selection: $tag) {
                        }
                    }
                    HStack {
                        NavigationLink(destination: ContentView2(), tag: 6, selection: $tag) {
                        }
                    }
                    HStack {
                        NavigationLink(destination: ContentView(), tag: 7, selection: $tag) {
                        }
                    }
                }
            }
...
struct modal_list_date_Previews: PreviewProvider {
