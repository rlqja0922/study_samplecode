...
std::string LEA::leadec(const char char1, const char char2) {
    ...
    BYTE pbUserKey[16] = { 0x0f, 0x1e, 0x2d, 0x3c, 0x4b, 0x5a, 0x69, 0x78, 0x87, 0x96, 0xa5, 0xb4, 0xc3, 0xd2, static_cast<BYTE>(char1), static_cast<BYTE>(char2) }; // 랜덤 암호화키
    BYTE pdwRoundKey[384] = { 0x0, };
    BYTE pbData[16] = { 0x4F, 0x50, 0x45, 0x4E, 0x44, 0x4C, byte1, byte2, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0 }; // OPENDL##
