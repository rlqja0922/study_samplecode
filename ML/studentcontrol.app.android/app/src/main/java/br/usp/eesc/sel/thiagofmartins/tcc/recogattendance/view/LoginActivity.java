...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    private void callPermission(){
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M && checkSelfPermission(Manifest.permission.READ_CONTACTS) != getPackageManager().PERMISSION_GRANTED){
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected Boolean doInBackground(Void... params) {
            ...
            Professor professor = DatabaseInteractor.getProfessorByEmail(LoginActivity.this, mEmail);

            if(professor != null){
                return professor.getPassword().equals(mPassword);
            }

            professor = new Professor();
            professor.setProfessorEmail(mEmail);
            professor.setPassword(mPassword);
            DatabaseInteractor.saveProfessor(LoginActivity.this, professor);
            return true;
        }
        ...
        protected void onPostExecute(final Boolean success) {
            ...
            if (success) {
                ...
                intent.putExtra("EXTRA_PROFESSOR_EMAIL", mEmail);
