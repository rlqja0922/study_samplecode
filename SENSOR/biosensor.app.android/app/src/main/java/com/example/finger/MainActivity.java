...
public class MainActivity extends AppCompatActivity {
    ...
    Button biometricLoginButton, biometricLoginButton2, biometricLoginButton3;
            ...
            purchaseButtonNotInvalidated.setOnClickListener(
                    new View.OnClickListener() {
                        ...
                        public void onClick(View view) {
                            status = BiometricManager.from(MainActivity.this).canAuthenticate();
                            if (status == BiometricManager.BIOMETRIC_SUCCESS) {
                                Toast.makeText(getApplicationContext(),
                                        "생체인식 사용가능", Toast.LENGTH_SHORT)
                                        .show();
//사용 가능
                                biometricPrompt.authenticate(promptInfo);
                            } else {
                                Toast.makeText(getApplicationContext(),
                                        "생체인식 불가능", Toast.LENGTH_SHORT)
                                        .show();
//사용 불가능
                            }
