package com.rebornsoft.soketchat;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        edit_msg = findViewById(R.id.et_msg);
            ...
            public void run() {
                ...
                try {
                    ...
                    if(ip.isEmpty() || port.isEmpty()){
                        ...
                        MainActivity.this.runOnUiThread(new Runnable() {
                            public void run() {
                                Toast.makeText(MainActivity.this, "서버와 연결 되었습니다.", Toast.LENGTH_SHORT).show();
                            }
                        });
                    }
                } catch (IOException e) {
                    ...
                    MainActivity.this.runOnUiThread(new Runnable() {
                        public void run() {
                            Toast.makeText(MainActivity.this, "인터넷 연결또는 Ip, Port 번호를 확인 해주세요.", Toast.LENGTH_SHORT).show();
