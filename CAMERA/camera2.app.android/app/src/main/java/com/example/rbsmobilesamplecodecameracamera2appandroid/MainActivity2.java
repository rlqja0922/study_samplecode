package com.example.rbsmobilesamplecodecameracamera2appandroid;
...
public class MainActivity2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.info).setOnClickListener(new Button.OnClickListener() {
            @Override
            public void onClick(View view) {
                AlertDialog show = new AlertDialog.Builder(MainActivity2.this)
    ...
    private void openCamera(int width, int height) {
        ...
        try {
            ...
            Toast.makeText(MainActivity2.this, "Cannot access the camera.", Toast.LENGTH_SHORT).show();
            finish();
   ...
   //     String fileName = String.format("%d.mp4", System.currentTimeMillis());
        mNextVideo =  new File(dired.getPath() + "/"+ts+".mp4");
    ...
    private void stopRecordingVideo() {
        ...
        Toast.makeText(MainActivity2.this, "Video saved: " + mNextVideoAbsolutePath,
